...
const SobreNosotros = () => {
  ...
  return <Layout title="Estudio de diseño web en Valencia | Valencia Web Studio" description="Estudio joven de diseño web en Valencia enfocado en comercio local.">
      {/* Hero Section */}
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="prose prose-lg animate-fade-in">
              <p className="font-body text-lg text-foreground leading-relaxed mb-4">Acabamos de empezar como estudio, sí, pero trabajamos cada proyecto con el mismo cariño que si fuera el nuestro. Profesionalidad, atención al detalle y trato cercano.</p>
      ...
      <section className="section-alt py-10 md:py-14">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-4xl mx-auto">
            {values.map((value, index) => <div key={index} className="text-center animate-slide-up" style={{
